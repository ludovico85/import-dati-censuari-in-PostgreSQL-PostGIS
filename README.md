...
Prima di importare il dato è necessario separare i tipi di record in altrettante tabelle (es. fab1, fab2, fab3, fab4 e fab5) in modo da non creare confusione nell'importazione del dato. L'operazione può essere fatta in excel, calc, ecc.
